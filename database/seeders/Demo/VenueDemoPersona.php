...
/**
 * „Pelso Rendezvényház" — the quote-driven persona (SLO-186, docs/20 §2.4).
 *
...
final class VenueDemoPersona extends DemoPersona
{
    ...
    public function profileSettings(): array
    {
        return [
            ...
            'social' => ['website' => 'https://pelso.demo.slot4u.hu'],
        ];
    }
