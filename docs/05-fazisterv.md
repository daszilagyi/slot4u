...
> **A jóváhagyási felület (SLO-144):** az SLO-136 a jóváhagyást hozta be gyors-műveletként; az **elutasítás** (kötelező indoklás) és az **alternatív időpont ajánlása** űrlapot igényel, ezért közös komponensekben (`components/admin/BookingApprovalSheets.tsx`) élnek, és a foglalás-listán ÉS a naptárkártyán ugyanazok. Részletek és a megőrzési szabályok: docs/04 §5.
