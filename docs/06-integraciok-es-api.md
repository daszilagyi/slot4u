...
2. **Phase 2:** Public API (`feature_api`, Max csomag) API kulcsos hitelesítéssel.
...
### Rate limiting (csomagonként)

| Csomag | Napi limit | Burst |
|---|---|---|
| Alap | 1 000 kérés/nap | 30/perc |
| Közepes | 10 000 kérés/nap | 120/perc |
| Max | korlátlan (fair use: 100 000/nap soft limit) | 600/perc |
...
- PM megjegyzés: a limit a csomag upsell-eszköze — a billing oldalon látszódjon a kihasználtság
