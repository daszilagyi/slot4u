...
return [
    ...
    'tenant' => [
        ...
        // A glam landing-sablon feliratai (SLO-241, docs/26). A tenant saját
        // szövegei (főcím, neon feliratok, csapat, kiemelt szolgáltatások) a
        // `tenants.landing` oszlopban élnek, nem itt.
        'glam' => [
            'nav' => [
                'services' => 'Szolgáltatások',
                'team' => 'Szakembereink',
            ...
            'book_cta' => 'Időpontot foglalok',
            'book_short' => 'Foglalás',
            'services_link' => 'Szolgáltatások megtekintése',
            'categories_title' => 'Miben segíthetünk?',
            'categories_lead' => 'Válaszd ki, mire vágysz, és böngéssz szolgáltatásaink között.',
            'popular_title' => 'Népszerű szolgáltatásaink',
            'popular_lead' => 'Válaszd ki a kedvenced, és foglalj időpontot online.',
            'services_all' => 'Összes szolgáltatás megtekintése',
            'service_cta' => 'Időpontot választok',
            'minutes' => ':count perc',
            'team_title' => 'Ismerd meg szakembereinket',
            'team_lead' => 'Tapasztalt csapatunk gondoskodik rólad.',
            'team_all' => 'Összes szakember',
            'team_cta' => 'Időpontok megtekintése',
            'anyone_title' => 'Mindegy, kihez',
            'anyone_lead' => 'Mutasd a legkorábbi időpontot',
            'anyone_cta' => 'Szabad időpontok',
            'quick_title' => 'Van :count perced magadra?',
            'quick_today' => 'Ma még van néhány szabad időpontunk.',
            'quick_tomorrow' => 'Holnap is van szabad időpontunk.',
            'quick_later' => 'Legközelebb :date van szabad időpontunk.',
            'quick_all' => 'Összes szabad időpont',
            'quick_time' => ':service, :time',
            'steps_title' => 'Foglalás, amíg megszárad a körömlakkod.',
            'steps_lead' => '3 egyszerű lépés, és kész is vagy!',
            'steps' => [
                'service' => 'Válassz szolgáltatást',
                'time' => 'Találj időpontot',
                'done' => 'Kész is vagy',
            ],
            'steps_hand' => 'Egyszerűen. Gyorsan. :brand-val.',
            'directions' => 'Útvonaltervezés',
            'contact_button' => 'Kapcsolat',
            'map_label' => ':address a térképen',
            'final_title' => 'Készen állsz egy kis énidőre?',
            'final_lead' => 'A következő időpontod csak néhány kattintásra van.',
            'final_cta' => 'Szabad időpontok megtekintése',
            'powered_by' => 'Foglalási rendszer:',
            'demo_note' => 'Ez az oldal egy demo landing page, amely a :brand online foglalási felület működését szemlélteti, hogy könnyebben elképzelhesd, hogyan üzemel majd a saját vállalkozásodban. A fotók a pexels.com oldalról származnak, a lajhár-figurák a :brand arculatának elemei. Minden adat fiktív.',
        ],
        ...
        'waitlisted' => [
            ...
            'title_place' => 'Várólista-helyed',
            'subtitle' => 'Értesítünk, amint felszabadul egy hely.',
            'position_label' => 'Pozíciód a várólistán',
            'event' => 'Esemény',
            'back' => 'Vissza a főoldalra',
            // SLO-103: tartós oldal, a hely aktuális állapotával.
            'code_label' => 'Várólista-kód',
            'status_label' => 'Állapot',
            'party_size' => 'Létszám',
            'keep_link' => 'Ezt az oldalt elmentheted: a hely állapotát bármikor itt látod.',
            'status' => [
                'waiting' => 'Várólistán',
                'offered' => 'Felszabadult egy hely',
                'converted' => 'Lefoglaltad a helyet',
                'expired' => 'Lejárt',
            ],
            'offered_title' => 'Felszabadult egy hely!',
            'offered_body' => 'Foglald le :deadline-ig, utána a következő várakozó kapja meg.',
            'offered_body_no_deadline' => 'Foglald le minél hamarabb, mert a hely a következő várakozóé lesz.',
            'offered_action' => 'Foglalás most',
            'converted_title' => 'Lefoglaltad a helyet',
            'converted_body' => 'A várólistáról sikeresen foglaltál. A foglalásod részleteit e-mailben küldtük el.',
            'expired_title' => 'Ez a várólista-hely lejárt',
            'expired_body' => 'A felajánlott helyet nem foglalták le időben, vagy az esemény már nem aktuális.',
        ],
        'quote_sent' => [
    ...
    'super' => [
        ...
        // Levélszöveg-szerkesztő (SLO-246, docs/27 §5): a slot4u saját levelei és
        ...
        'mail_texts' => [
            ...
            'names' => [
                ...
                'reset_password' => 'Új jelszó beállítása',
                'staff_invitation' => 'Dolgozói meghívó',
                'commission_invoice_issued' => 'Jutalékszámla elkészült',
                ...
                'booking_rejected' => 'Foglalás elutasítva',
                'waitlist_offer' => 'Várólista: felszabadult hely',
                'reminder_24h' => 'Emlékeztető (24 órával előtte)',
                'quote_ready' => 'Árajánlat elkészült',
                'message_received' => 'Új üzenet',
            ],
            'customised' => 'Átírva',
            'default' => 'Alapszöveg',
            'fields' => [
            ...
            'save' => 'Mentés',
            'saved' => 'A levélszöveg elmentve. A következő levél már így megy ki.',
            'reset' => 'Vissza az alapszövegre',
            'reset_confirm' => 'Biztosan visszaállítod ennek a levélnek az alapszövegét?',
            'reset_done' => 'A levélszöveg visszaállt az alapszövegre.',
            'discard' => 'Módosítások elvetése',
            'unsaved' => 'Mentetlen módosítás',
            'unsaved_confirm' => 'Mentetlen módosításaid vannak. Biztosan másik levélre váltasz?',
            'errors' => [
                'html' => 'HTML nem használható a levélszövegben — a címzett a jelöléseket szó szerint látná.',
                'image' => 'Kép nem illeszthető a levélszövegbe.',
                'variables' => 'Ismeretlen változó: :variables. Csak a felsorolt változók használhatók.',
            ],
            'preview' => [
                'title' => 'Előnézet',
                ...
                'failed' => 'Az előnézet nem töltődött be.',
                'frame_title' => 'A levél előnézete',
                'sample_note' => 'Minta adatokkal, a jelenlegi email-designnal.',
            ],
            ...
            'samples' => [
                ...
                'period' => '2026-08',
                'amount' => '12 500 Ft',
                'due' => '2026. szeptember 15.',
                'date' => '2026. december 14.',
                'code' => 'K7M2QX',
                'service' => 'Hajvágás és szárítás',
                'when' => '2026-10-03 10:00',
                'previous' => '2026-10-02 14:00',
                'reason' => 'A szolgáltató megbetegedett.',
    ...
    'audit_action' => [
        ...
        'platform' => [
            ...
            // Levélszövegek (SLO-246).
            'mail_text_updated' => 'Levélszöveg módosítva',
            'mail_text_reset' => 'Levélszöveg visszaállítva az alapértelmezettre',
        ],
    ...
    'mail' => [
        ...
        'booking_modified' => [
            ...
            'previous' => 'Korábbi időpont: :previous',
